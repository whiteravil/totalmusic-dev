$(function() {
	...
	$('.search-location-input').on('input', function() {
		if ( $(this).val().trim().length > 0 ) {
			$('.location-search-drop').addClass('opened')
		}
		else {
			$('.location-search-drop').removeClass('opened')
		}
	});

	$('.search-location-input').blur(function() {
		$('.location-search-drop').removeClass('opened')
	});

	$('.product-sound-btn').on('click', function(e) {
		e.preventDefault();
		$('.product-sound-btn').toggleClass('played')
	});

	$('.product-gift-link').on('click', function(e) {
		e.preventDefault();
		$('.product-gift-drop').toggleClass('opened');
	});
	...
	$('.open-mail-form').on('click', function(e) {
		e.preventDefault();
		$('#sign-in-phone').hide();
		$('#sign-in-mail').fadeIn(400)
	});

	$('.open-phone-form').on('click', function(e) {
		e.preventDefault();
		$('#sign-in-mail').hide();
		$('#sign-in-phone').fadeIn(400)
	});

	$('.header-location-dropdown-btns .btn').on('click', function(e) {
		e.preventDefault();
		$('.header-location-dropdown').removeClass('visible')
	});
